...
module.exports = async function spy(message, client) {
    try {
        ...
        if (message.guild?.id !== '1195522221901369455') return;
        ...
        //};
        const channelMapping = {
            '1249882503204962314': '889592085747990589',  // опочивальня → лог 1
            '1273446816053989521': '883608296664203334',  // расписание → лог 2
            '1426742945482276874': '883608296664203334',  // новости → лог 2
            '1426739496522743870': '563752253090168863'   // чат ги → лог 3
        };
